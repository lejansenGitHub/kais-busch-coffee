import"./modulepreload-polyfill-B5Qt9EMX.js";import{S as v}from"./skills-C6ifZiiC.js";import{a as r,I as o,S as p}from"./hero-data-D1MqVU-7.js";const $=document.querySelector("#app"),d=Object.entries(v),c=d.filter(([,i])=>i.type==="A"),u=d.filter(([,i])=>i.type==="P");function m([i,s]){const e=s.type==="A",t=e?"active":"passive",n=e?`${s.maxUses} use${s.maxUses!==1?"s":""}`:"∞",l=p[i];return`
