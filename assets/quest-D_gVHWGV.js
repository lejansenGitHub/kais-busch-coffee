    ...
    <div class="character-card">
      ...
      ${n.quests.map((i,r)=>`
        <div class="quest-block">
          <div class="quest-number">Quest ${r+1}</div>
      ...
      `).join("")}
    </div>`:t.innerHTML="<p>Unbekannter Quest-Charakter.</p>";
