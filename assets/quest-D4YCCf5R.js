        ...
        <div class="quest-block">
          ...
          <div class="quest-section">
            ...
            <div class="quest-rewards">
              ${t.rewards.map(e=>{let r,i,s;return e.type==="skill"?(r=l[e.id].name,i=h[e.id],s="S"):e.type==="item"?(r=e.id.replace(/_/g," ").replace(/\b\w/g,u=>u.toUpperCase()),i=c[e.id],s="I"):(r=e.name,i=null,s="Q"),`
