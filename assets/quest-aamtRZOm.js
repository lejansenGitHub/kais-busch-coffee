...
What German word is hidden here?</em>`,criteria:["All three German words were correctly guessed and spoken to Elena"],rewards:[{type:"skill",name:"Insight",code:"7835"}]}]}},n=document.querySelector("#app"),i=n.dataset.character,a=r[i];a?n.innerHTML=`
    <div class="character-card">
      ...
      `).join("")}
    </div>`:n.innerHTML="<p>Unknown quest character.</p>";
