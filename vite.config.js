  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'character-sheets-kai-weak': resolve(__dirname, 'character-sheets/kai-weak/index.html'),
        ...
        'character-sheets-simon-strong': resolve(__dirname, 'character-sheets/simon-strong/index.html'),
        ...
        'character-sheets-essen': resolve(__dirname, 'character-sheets/essen/index.html'),
        ...
        'character-sheets-hubi-endboss': resolve(__dirname, 'character-sheets/hubi-endboss/index.html'),
        'character-sheets-guide': resolve(__dirname, 'character-sheets/guide/index.html'),
        'character-sheets-karte': resolve(__dirname, 'character-sheets/karte/index.html'),
      },
    },
  },
});
